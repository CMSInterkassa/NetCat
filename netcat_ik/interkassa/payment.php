...
<link rel="stylesheet" href="/netcat_template/class/interkassa/css/interkassa.css">
</head>
<body>
<div class="interkasssa" style="text-align: center;margin-top: 5%;">
    <img style="display: inline-block;" src="/netcat_template/class/interkassa/images/logo_interkassa.png"/>
    ...
    <input class="btn btn-lg btn-success" type="submit" value="Выбрать платежный инструмент">
</form>
<?php
if ($this->get_setting('api_enable') && $this->get_setting('api_id') && $this->get_setting('api_key')) {
    include_once $nc_core->TEMPLATE_FOLDER . 'interkassa/modal_ps.php';
}
?>
